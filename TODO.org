...
** Implement Smart Indexer with SpecialFile
*** do not reindex project + gems everytime -- only when special file changes
*** Consume Event#IsSpecial in Project#Monitor and Indexer#Index
*** keep two files and concat to one in any case
** Write README
